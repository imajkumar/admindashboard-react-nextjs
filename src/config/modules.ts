    ...
    subModules: [
      {
        ...
        path: "/email/send",
        icon: "SendOutlined",
        description: "Send single or bulk emails",
        enabled: true,
        permissions: ["email:write"],
        features: ["single-email", "bulk-email", "attachments"],
      },
      {
        id: "email-templates",
        name: "Templates",
        ...
        features: ["templates", "preview", "edit"],
      },
      {
        id: "email-history",
        name: "Email History",
        ...
        enabled: true,
        permissions: ["email:read"],
        features: ["history", "logs", "analytics"],
      },
    ],
    features: ["email-sending", "templates", "bulk-operations", "attachments"],
  },
  {
    id: "content",
